...
import type { AgentCustoms, AgentFunction } from './types.js'

/**
 * Core HTTP transport for the Clubhouse private API. Returns the raw
 * `Response` so callers can parse JSON themselves.
 */
